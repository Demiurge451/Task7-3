...
public class GraphDemoFrame extends JFrame {
    ...
    public GraphDemoFrame() {
        ...
        buttonBfsQueue.addActionListener(e -> {
            try {
                if (graph == null) {
                    return;
                }
        ...
        buttonExecute.addActionListener(e -> {
            try {
                ...
                showSystemOut(() -> {
                    ...
                    count[from] = 1;
                    int res = ru.vsu.cs.course1.graph.demo.GraphUtils.minCycle(graph, from, Integer.MAX_VALUE, count, prev, visited);
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        panel3.add(buttonExecute, new GridConstraints(1, 1, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        buttonBfsQueue = new JButton();
        buttonBfsQueue.setText("bfs (очередь)");
        panel6.add(buttonBfsQueue, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
